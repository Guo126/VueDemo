  ...
  <header>
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
       <a class="py-2" href="#">
          ...
          stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="d-block mx-auto"><circle cx="12" cy="12" r="10">
            </circle><line x1="14.31" y1="8" x2="20.05" y2="17.94"></line><line x1="9.69" y1="8" x2="21.17" y2="8"></line>
...
export default {
  ...
  methods:{
    change(){
      //this.headerMsg = "Msg Changed"
      this.$emit("msgChanged","子向父组件传值")
    }
  }
}
</script>
